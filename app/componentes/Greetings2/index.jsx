            ...
            <div className={styles.sobremim}>
                <div className={styles.sobremimC}>
                    ...
                    <div className={styles.sobreMimContainer}>
                        <h6>
                        Presentemente, estou cursando o <strong>quinto período</strong> de <strong>Análise e Desenvolvimento de Sistemas</strong> na universidade UniCarioca. Pessoalmente, estou me aprofundando em <strong>Dados</strong> e em breve pretendo estudar Mobile.<br/><br/><br/>
